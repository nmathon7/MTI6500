CREATE DATABASE o3fs LOCATION 'o3fs://buckhive.volo3fs.localhost/' WITH DBPROPERTIES ('Auteur' = 'Nicolas Mathon', 'Date' = '2024-03-16', 'Description' = 'Description' = 'Base de données créée dans le système de fichier Ozone.');

DROP DATABASE IF EXISTS ozone CASCADE;

CREATE DATABASE ozone LOCATION 'o3fs://buckhive.volo3fs.localhost/' WITH DBPROPERTIES ('Auteur' = 'Nicolas Mathon', 'Date' = '2024-03-16', 'Description' = 'Description' = 'Base de données créée dans le système de fichier Ozone.');
...
(hashid char(130), anneemeq int, sessionmeq char(1), codemeq char(8), groupe string, notecours string, notecoursdec string, coderemarque string, moyennegroupe strin>
ROW FORMAT DELIMITED
FIELDS TERMINATED BY ';'
STORED AS TEXTFILE
